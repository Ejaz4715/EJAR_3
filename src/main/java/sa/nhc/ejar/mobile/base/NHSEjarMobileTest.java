package sa.nhc.ejar.mobile.base;

import sa.nhc.ejar.mobile.NHSEjarMobileApplication;
...
public class NHSEjarMobileTest extends TestCrewMobileBaseTest {

    public NHSEjarMobileApplication app;

    public NHSEjarMobileTest() {
        app = new NHSEjarMobileApplication();
    }
